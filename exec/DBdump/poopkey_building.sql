...
CREATE TABLE `building` (
  ...
  `building_lat` double DEFAULT NULL,
  `building_lng` double DEFAULT NULL,
...
INSERT INTO `building` VALUES (1,1,'SSAFY 서울 캠퍼스',37.5012851921,127.0396046633,0,'서울시 강남구 테헤란로 212');
