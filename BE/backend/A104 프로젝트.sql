...
ALTER TABLE `restroom` ADD CONSTRAINT `PK_RESTROOM` PRIMARY KEY (
	`restroom_id`
);
...
ALTER TABLE `stall` ADD CONSTRAINT `PK_STALL` PRIMARY KEY (
	`stall_id`
);

ALTER TABLE `toilet` ADD CONSTRAINT `PK_TOILET` PRIMARY KEY (
	`toilet_id`
);
